                        ...
                        <div className="">
                            <FormWrapper>
                                ...
                                <FormContainer className='pt-8'>
                                    ...
                                    <DropdownInput label='Stream(s)' options={[{ value: 'Stream 1' }, { value: 'Stream 2' }]} />
                                    <TextInput label='Date Window' />
                                ...
                                <FormContainer optional={true} className='bg-[#f6f6f640]'>
                                    ...
                                    <DropdownInput label='Linked Stock Checks' options={[{ value: 'Stock Check 1' }, { value: 'Stock Check 2' }]} />
                                    <DropdownInput label='Linked Collections' options={[{ value: 'Collection 1' }, { value: 'Collection 2' }]} />
