            ...
            <div className="grid grid-cols-[auto_1fr]">
                ...
                <main className="relative w-full bg-secondarygrey">
                    ...
                    <div className="p-8 mt-20">
                        <DeliveriesTable data={tableData} layout={layout} onLayoutChange={setLayout} sort={sort} setSort={setSort} tableData={tableData} setTableData={setTableData} topTableData={topTableData} setTopTableData={setTopTableData} bottomTableData={bottomTableData} setBottomTableData={setBottomTableData} />
                    </div>
                </main>
            </div>
        </>
