...
import StockChecksTable from "../../../../../components/stockChecksTable"
            ...
            <div className="grid grid-cols-[auto_1fr]">
                ...
                <main className="relative w-full bg-secondarygrey">
                    ...
                    <div className="p-8 mt-20">
                        <Link
                            href={{
                                pathname: '/[ServiceProviderID]/[CompanyID]/[ManagedCompanyID]/products/stock-checks',
                                query: {
                                    ServiceProviderID: `${router.query['ServiceProviderID']}1`,
                                    CompanyID: router.query['CompanyID'],
                                    ManagedCompanyID: router.query['ManagedCompanyID']
                                }
                            }}
                        >
                            dynamic Link
                        </Link>
                        {router.query['ServiceProviderID']}
                        {router.query['CompanyID']}
                        {router.query['ManagedCompanyID']}
                        <StockChecksTable data={tableData} layout={layout} onLayoutChange={setLayout} sort={sort} setSort={setSort} tableData={tableData} setTableData={setTableData} topTableData={topTableData} setTopTableData={setTopTableData} bottomTableData={bottomTableData} setBottomTableData={setBottomTableData} />
                    </div>
                </main>
            </div>
        </>
