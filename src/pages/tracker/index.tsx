...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-[auto_1fr] bg-secondarygrey">
                ...
                <main className="relative w-full bg-secondarygrey">
                    ...
                    <div className="absolute inset-x-8 z-50 flex justify-between items-center rounded-2xl bg-primary p-5 mr-4">
                        <div className="w-[500px] text-xs text-white">
                            <p>
                                Welcome to your tracker overview! Here you can view general venue stats from all time, or select a date window to filter your results. You can also customise this page using the modify dashboard widget panel.
                            </p>
                        </div>
                        <HeaderButton>
                            <div className="flex cursor-pointer select-none flex-wrap items-center text-lg">
                                <p className="pr-4">Modify Dashboard Widgets</p>
                    ...
                    <div className="mt-20 p-8 mr-4">
                        <div className="grid grid-cols-4 gap-4 auto-rows-[192.5px]">
                            <div className="flex flex-col rounded-2xl bg-white pt-8 px-4 col-span-2 row-span-2 justify-around">
                                <div className="flex justify-around">
                                    <div className="flex flex-col justify-between w-full h-full rounded-2xl row-span-2">
                                        ...
                                        <div className='flex place-content-center pb-6'>
                                            <DonutProgress data={90} duration={750} colour="#49cc73" backgroundColour="#ececec" size={150} />
                                        </div>
                                    </div>
                                    <div className="flex flex-col justify-between w-full h-full rounded-2xl row-span-2">
                                        <div className='t text-center text font-semibold mb-4'>
                                        ...
                                        <div className='flex place-content-center pb-6'>
                                            <DonutProgress data={80} duration={750} colour="#49cc73" backgroundColour="#ececec" size={150} />
                                        </div>
                                    </div>
                                </div>
                                <div className="p-2">
                                    <div className="flex overflow-auto p-2">
                                        <div className="flex flex-col justify-between w-[500px] h-full border bg-white rounded-2xl row-span-2 shadow-lg p-4 mr-2">

                                            <div className='flex place-content-center items-center'>
                                                <div className="pr-4">

                                                    <DonutProgress data={90} duration={750} colour="#49cc73" backgroundColour="#ececec" size={70} />
                                                </div>
                                                <div className="flex flex-col text-xs pr-4">
                                                    <div className="whitespace-nowrap font-bold pb-2">Stream 1</div>
                                                    <div className="whitespace-nowrap">rPET, Paper, Food</div>
                                                    <div className="whitespace-nowrap">1230kg Delivered</div>
                                                    <div className="whitespace-nowrap">1230kg Delivered</div>
                                                </div>
                                            </div>
                                        </div>
