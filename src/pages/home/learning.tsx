                ...
                <main className="relative w-full bg-secondarygrey">
                    ...
                    <div className="flex flex-col bg-gradient-to-b from-primary to-tertiary z-10 py-8 pl-4 pr-8">
                        ...
                        <div className="grid grid-cols-3 w-full z-50 gap-16 px-8">
                            <div className='bg-secondaryblack text-white rounded-2xl justify-between h-full w-full p-8 flex flex-col shadow-lg hover:scale-105 transition duration-200'>
                                <div className='text-left font-bold text-2xl leading-7'>
                                    Custom Learning Materials
                                </div>
                                <div className="l leading-4 text-sm mt-2">
                            ...
                            <div className='bg-white rounded-2xl h-full w-full p-8 flex flex-col justify-between shadow-lg hover:scale-105 transition duration-200'>
                                <div className='text-left font-bold text-2xl'>
                                    How to run a rubbish festival
                                </div>
