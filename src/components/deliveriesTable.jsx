...
import ExpandedDeliveryCard from './expandedDeliveryCard';

const DeliveriesTable = ({ data, layout, onLayoutChange, sort, setSort, tableData, setTableData, topTableData, setTopTableData, bottomTableData, setBottomTableData }) => {
                ...
                <div className='absolute modal left-0 top-0 z-50'>
                    <div className=' fixed grid place-content-center inset-0 z-50'>
                        <div className='w-[600px] h-[550px] inset-0 z-50'>
                            <ExpandedDeliveryCard {...selectedData} isOpen={showModal} setIsOpen={setShowModal} />
                        </div>
