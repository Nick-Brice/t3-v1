...
const WasteCollectionsTable = ({ data, layout, onLayoutChange, sort, setSort, tableData, setTableData, topTableData, setTopTableData, bottomTableData, setBottomTableData }) => {
                ...
                <div className='absolute modal left-0 top-0 z-50'>
                    <div className=' fixed grid place-content-center inset-0 z-50'>
                        <div className='w-[600px] h-[550px] inset-0 z-50'>
                            <ExpandedWasteCollectionCard {...selectedData} isOpen={showModal} setIsOpen={setShowModal} />
                        </div>
            ...
            {layout === 'grid' && (
                <div className="grid grid-cols-4  gap-4 min-h-0">
                    ...
                    {tableData.map((row) => (
                        ...
                        <WasteCollectionCard title={row.name} img="/Cup_PET.png" delivered={row.delivered} collected={row.collected} stream={row.stream} rate={row.rate} key={row.name}>
                        </WasteCollectionCard>
...
export default WasteCollectionsTable;
