...
export default function ModifyWasteCollection(props) {
        ...
        <>
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col select-none gap-y-6 py-8 px-24 rounded-2xl bg-gradient-to-l from-primary to-secondary text-white'>
                    ...
                    <div>
                        <button type='submit' className='bg-white  drop-shadow-2xl text-black rounded-xl w-full h-16 font-semibold text-lg'>
