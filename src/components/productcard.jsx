...
export default function ProductCard(props) {
    ...
    return (
        <div className='bg-secondarywhite rounded-xl p-8 grid grid-cols-[7fr_3fr] grid-row-4'>
            <h5 className='my-4 col-start-1'>{props.title}</h5>
            <div className='col-start-2 row-span-2 place-self-center w-full h-3/4 bg-primary-50'><img width="100%" src={props.img}></img></div>
